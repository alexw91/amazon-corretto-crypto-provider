...
public class AccessibleByteArrayOutputStreamTest {
  ...
  public void bufferGrowthResizeToIntMax() throws Throwable {
    ...
    /* If we had a buffer of 32 bytes, and we need 1 more byte, we should resize to 64 bytes */
    ...
    /* Ensure resizing values between INT_MAX/2 and INT_MAX are clamped to INT_MAX */
